...
class SaveVariables {
	...
	public var hpDrain:Bool = true;
	public var hpDrainAmount:Float = 0.01;
	public var hpDrainStop:Bool = true;
	public var hpDrainStopValue:Float = 0.2;
	public var onlyIcons:Bool = false;
	public var iconBobAngle:Float = 11.25;
...
class ClientPrefs {
	//public static var onlyIcons(default, null):?;
