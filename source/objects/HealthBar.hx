...
class HealthBar extends FlxSpriteGroup
{
	...
	public function updateBar()
	{
		...
		barCenter = leftBar.x + leftSize +
			barOffset.x; // barCenter = (ClientPrefs.data.onlyIcons) ? (leftBar.x + leftSize + barOffset.x) : (barWidth / 2); // Parhentisies cus haxe is retarted!
