...
class DialogueEditorState extends MusicBeatState
{
	...
	function addDialogueLineUI() {
		...
		var loadButton:FlxButton = new FlxButton(20, lineInputText.y + 25, "Load Dialogue File", function() {
			loadDialogue();
		});
		var saveButton:FlxButton = new FlxButton(loadButton.x + 120, loadButton.y, "Save Dialogue as File", function() {
			saveDialogue();
		});

		tab_group.add(new FlxText(10, speedStepper.y - 18, 0, 'Interval (ms):'));
		tab_group.add(new FlxText(10, characterInputText.y - 18, 0, 'Character:'));
		tab_group.add(new FlxText(10, soundInputText.y - 18, 0, 'Sound file name (sounds/):'));
	...
	private static var DEFAULT_TEXT:String = "2.2 When?";
