...
class EditorPlayState extends MusicBeatSubstate
{
	...
	public function new(playbackRate:Float)
	{
		...
		dataTxt = new FlxText(10, 580, FlxG.width - 20, "Bar: 0", 20);
		...
		var tipText:FlxText = new FlxText(10, FlxG.height - 24, 0, 'Press ESC to Go Stop', 16);
		...
		DiscordClient.changePresence('Chart Editor: Playtest mode', PlayState.SONG.song, null, true, songLength);
		#end
		RecalculateRating();
	}
