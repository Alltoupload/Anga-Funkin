...
class WeekEditorState extends MusicBeatState
{
	...
	function addEditorBox() {
		...
		var freeplayButton:FlxButton = new FlxButton(0, 650, "Switch to Freeplay view", function() {
	...
	public static var weekFileName:String = 'week6';
	...
	function addWeekUI() {
		...
		hideCheckbox = new FlxUICheckBox(10, weekFileInputText.y + 40, null, null, "Are the week's songs bonuses?", 100);
		...
		tab_group.add(new FlxText(displayNameInputText.x, displayNameInputText.y - 18, 0, 'Display Name (Shown in top-right corner):'));
	...
	function addOtherUI() {
		...
		hiddenUntilUnlockCheckbox = new FlxUICheckBox(10, lockedCheckbox.y + 25, null, null, "Hidden while locked?", 110);
...
class WeekEditorFreeplayState extends MusicBeatState
{
	...
	function addEditorBox() {
		...
		var storyModeButton:FlxButton = new FlxButton(0, 685, "Back to Story Mode View", function() {
